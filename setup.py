...
setup(
    ...
    author='Lyam Dolk',
    author_email='Lyam.Dolk@utb.linkoping.se',
    version="0.0.1",
    ...
    py_modules=["lkpg_eunomia"],  # packages i am publishing
    ...
    install_requires=["pandas", "selenium", "time", "os"],  # production run need thees packages
    extras_require={
        "dev": ["pytest>=3.7",
                "check-manifest>=4.8",
                "twine>=4.0.1"]
