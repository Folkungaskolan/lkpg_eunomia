...
from utils.file_utils.staff_db import get_staff_user_from_db, update_staff_user
from utils.web_utils.general_web import init_chrome_webdriver


@function_timer
def update_single_staff_info_from_web(user_id: str,
...
def update_all_staff_info_from_web(headless_input_bool: bool = False) -> None:
    ...
    for staff in staff_list:
        ...
        try:
            local_session = update_single_staff_info_from_web(user_id=staff.user_id,
