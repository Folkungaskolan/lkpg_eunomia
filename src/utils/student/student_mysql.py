...
def save_student_information_to_db(user_id: str,
    ...
    if student is None:
        ...
        student = _add_info_to_student_obj(student_obj=student, first_name=first_name, last_name=last_name, klass=klass, skola=skola, birthday=birthday,
                                           eduroam_pw=eduroam_pw, google_pw=google_pw, webid=webid)
...
def _add_info_to_student_obj(student_obj: Student_dbo, first_name: str = None, last_name: str = None, klass: str = None, skola: str = None, birthday: str = None,
                             eduroam_pw: str = None, google_pw: str = None, webid: str = None) -> Student_dbo:
    ...
    if google_pw is not None:
        student_obj.google_pw = google_pw
